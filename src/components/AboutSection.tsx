...
const AboutSection = () => {
  const stats = [
    ...
    { icon: Film, label: 'Videos Recorded', value: '25+' },
    { icon: ImageIcon, label: 'Locations Visited', value: '30+' },
  ];

  return (
    <section id="about" className="py-20 bg-gradient-to-br from-ocean-900 to-ocean-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-ocean-200 mb-6 leading-relaxed">
            ...
            <p className="text-lg text-ocean-200 mb-8 leading-relaxed">
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div
              className="absolute -bottom-4 -left-4 bg-sunset-500 text-white p-4 rounded-lg shadow-lg animate-wave"
